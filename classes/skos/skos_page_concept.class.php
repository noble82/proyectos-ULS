...
// +-------------------------------------------------+
// $Id: skos_page_concept.class.php,v 1.3 2015-12-03 11:39:45 vtouchard Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

require_once($class_path."/authorities/page/authority_page.class.php");
require_once($class_path."/authorities/tabs/authority_tabs_concept.class.php");
...
class skos_page_concept extends authority_page {
	...
	protected function get_authority_tabs(){
		if(!$this->authority_tabs){
			$this->authority_tabs = new authority_tabs_concept($this->authority);
		}
