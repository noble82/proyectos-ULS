...
// +-------------------------------------------------+
// $Id: authperso.class.php,v 1.6 2015-10-16 13:19:23 ngantier Exp $
...
class authperso {
	...
	public static function get_isbd($id){
		...
		if(($r=pmb_mysql_fetch_object($res))) {			
			$p_perso=new custom_parametres_perso("authperso","authperso",$r->authperso_authority_authperso_num,"./autorites.php?categ=authperso&sub=update&id_authperso=".$id,$option_navigation,$option_visibilite);
