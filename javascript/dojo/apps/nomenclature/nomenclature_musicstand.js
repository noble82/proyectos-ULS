...
// +-------------------------------------------------+
// $Id: nomenclature_musicstand.js,v 1.23 2016-01-05 09:10:06 vtouchard Exp $
	 ...
	 */
	  return declare(null, {
			...
			calc_effective: function(){
				var effective = 0;
				if(this.indefinite_effective){
					if(!this.get_used_by_workshops()){
						this.effective = this.family.nomenclature.indefinite_character; 
					}else{
						this.displayed_effective = this.family.nomenclature.indefinite_character;
					}
				}else{
					if(!this.get_used_by_workshops()){
						for(var i=0; i<this.instruments.length ; i++){
