...
// +-------------------------------------------------+
// $Id: install_rep.php,v 1.41 2015-12-03 16:20:28 dgoron Exp $
...
if (($Submit == "OK") && (($dbname!="") || ($dbnamedbhost!=""))) {
	...
	$data_test = (isset($_POST["data_test"]) ? $_POST["data_test"] : 0);
	$data_test_cms = (isset($data_test_cms) ? $data_test_cms : 0);
	
	$thesaurus = (isset($_POST["thesaurus"]) ? $_POST["thesaurus"] : "");
	...
	//DG - Paramètre caché pour lancer la ré-indexation à la connexion
	@pmb_mysql_query("INSERT INTO parametres (id_param, type_param, sstype_param, valeur_param, comment_param, section_param, gestion) VALUES (NULL, 'pmb', 'indexation_must_be_initialized', '1', 'Les tables dynamiques doivent-elles être initialisées ? \n 0 : non \n 1 : oui', '', '1')",$link);
