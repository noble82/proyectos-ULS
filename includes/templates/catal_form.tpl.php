...
// +-------------------------------------------------+
// $Id: catal_form.tpl.php,v 1.152 2016-01-05 09:17:03 ngantier Exp $
...
if($pmb_authors_qualification){
	...
	$authors_qualification_tpl="
        ...
        <div style='float:left;'>
			...
			<input class='bouton' type='button' onclick='duplicate(1,!!iaut!!);' value='Dupliquer'>
...
if($pmb_authors_qualification){
	...
	$authors_qualification_tpl="
        ...
        <div style='float:left;'>
			...
			<input class='bouton' type='button' onclick='duplicate(2,!!iaut!!);' value='Dupliquer'>
...
$ptab[130]="
		...
		<div class='colonne'>
			...
			<div id='el11Child_0d' class='row'>
				<input type='text' class='saisie-80emr' id='f_rel_!!n_rel!!' name='f_rel_!!n_rel!!' data-form-name='f_rel_' value=\"!!notice_relations_libelle!!\" completion=\"notice\" autfield=\"f_rel_id_!!n_rel!!\" autexclude=\"!!notice_id_no_replace!!\"/>
				...
				<input type='hidden' id='f_rel_rank_!!n_rel!!' name='f_rel_rank_!!n_rel!!' data-form-name='f_rel_rank_' value='!!notice_relations_rank!!'/>
