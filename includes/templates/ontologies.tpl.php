...
// +-------------------------------------------------+
// $Id: ontologies.tpl.php,v 1.1 2015-08-10 23:16:25 arenou Exp $
...
$ontologies_list_item = "
		<tr !!tr_javascript!!>
			<td>!!label!!</td>
			<td>!!description!!</td>
		<td><input type='button' class='bouton' value='Télécharger' onclick='window.open(\"./ontologie.php?ontologie_id=!!id!!\");return false'/></td>
		</tr>";
