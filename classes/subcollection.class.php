...
// +-------------------------------------------------+
// $Id: subcollection.class.php,v 1.63 2015-12-21 15:41:49 vtouchard Exp $
...
// ---------------------------------------------------------------
	...
	var $comment;			//Sub collection comment
	var $num_statut = 1;
	...
	static function update_index($id) {
		...
		// Pour chaque n-uplet trouvés on met a jour la table notice_global_index avec la sous-collection modifiée :
