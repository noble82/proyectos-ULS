...
// +-------------------------------------------------+
// $Id: aut_pperso.class.php,v 1.8 2015-10-28 16:49:33 dgoron Exp $
...
class aut_pperso {
	...
	function get_form() {
		...
		for ($i=0; $i<count($perso_["FIELDS"]); $i++) {
			...
			$perso.="<div id='el9Child_".$i."' class='row' movable='yes' title=\"".htmlentities($p["TITRE"], ENT_QUOTES, $charset)."\">";
