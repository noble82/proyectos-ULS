...
// $Id: tablist.js,v 1.22 2015-12-03 11:39:45 vtouchard Exp $
...
function expandAll_ajax(start, context) {
	...
	var tempColl_img = context.getElementsByTagName('IMG');
	var tempColl = context.getElementsByTagName('DIV');
	var liste_id='';
	var display_cmd='';
	var nb_to_send=0;
	var nb=0;
...
function expandAll(context) {
  ...
  tempColl    = context.getElementsByTagName('IMG');
