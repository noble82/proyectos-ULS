...
// +-------------------------------------------------+
// $Id: vedette_common.tpl.php,v 1.6 2015-12-10 15:42:43 ngantier Exp $
...
<script type="text/javascript">
	...
	var vedette_element =  {
		...
		create_box : function(caller_property_name,vedette_type, parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel, vedette_composee_order) {
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.create_box(caller_property_name,parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel, vedette_composee_order);
		},

		update_box : function(vedette_type, parent, vedette_composee_subdivision_id, vedette_composee_element_order, vedette_composee_order) {
			...
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.create_box(caller_property_name,parent, vedette_composee_subdivision_id, vedette_composee_element_order, element_id.value, text.value, text.getAttribute("rawlabel"), vedette_composee_order);
		},
