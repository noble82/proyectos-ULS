...
// +-------------------------------------------------+
// $Id: form.inc.php,v 1.36 2015-11-06 15:13:22 dgoron Exp $
...
<div class='row'>
	<input type='checkbox' value='268435456' name='index_authorities'>&nbsp;<label class='etiquette'>".htmlentities($msg["nettoyage_index_authorities"], ENT_QUOTES, $charset)."</label>
</div>";
print "
	</div>
