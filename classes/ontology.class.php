...
// +-------------------------------------------------+
// $Id: ontology.class.php,v 1.4 2015-08-17 21:02:42 arenou Exp $
...
class ontology {
	...
	private function fetch_datas(){
		...
		if($this->id){
			$query = "select id_ontology, ontology_name, ontology_description, ontology_creation_date from ontologies where id_ontology = ".$this->id;
	...
	public function get_values_from_form(){
		global $ontology_id,$ontology_name,$ontology_description;
	...
	public function save(){
		...
		$result = mysql_query($query.$where,$dbh);
		if(!$this->id){
