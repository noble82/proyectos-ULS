...
// +-------------------------------------------------+
// $Id: marc_table.class.php,v 1.35 2015-12-04 11:35:52 dgoron Exp $
...
// méthodes
	...
	private function gen_radio_item($value, $libelle){
		...
		return "&nbsp;<input type='radio' name='".$this->name."' value='".htmlentities($value,ENT_QUOTES,$charset)."'".$selected.$onchange."/>&nbsp;<label>".htmlentities($libelle,ENT_QUOTES,$charset)."</label>";
	}
