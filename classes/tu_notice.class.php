...
// +-------------------------------------------------+
// $Id: tu_notice.class.php,v 1.18 2015-11-19 15:59:08 vtouchard Exp $
		...
		switch($type) {
			...
			default:
				...
				foreach ($this->ntu_data as $tu) {
					...
					$flag_first=1;
					//$link="<a href='./autorites.php?categ=titres_uniformes&sub=titre_uniforme_form&id=".$tu->num_tu."' class='lien_gestion'>".$tu->tu->display."</a>";
					$link="<a href='./autorites.php?categ=see&sub=titre_uniforme&id=".$tu->num_tu."' class='lien_gestion'>".$tu->tu->display."</a>";
					$biblio_fields=array(); 
