...
// +-------------------------------------------------+
// $Id: serie.class.php,v 1.62 2015-12-21 15:41:49 vtouchard Exp $
...
function serie($id=0) {
	if($id) {
		// on cherche à atteindre un titre de série existant
		$this->s_id = $id;
		$this->getData();
		} else {
		// le titre de série n'existe pas
		$this->s_id = 0;
		$this->getData();
		}
	}
