...
// +-------------------------------------------------+
// $Id: notice_affichage.class.php,v 1.436 2016-01-13 15:41:40 apetithomme Exp $
...
class notice_affichage {
	...
	function fetch_titres_uniformes() {
		...
		$this->notice->tu_print_type_2=$this->notice->tu->get_print_type(2,"./index.php?lvl=titre_uniforme_see&id=" );
	...
	function genere_double($depliable=1, $premier='ISBD') {
		...
		if ($this->affichage_resa_expl || $this->notice_childs || $this->affichage_avis_detail || $this->affichage_simili_search_head || $this->affichage_demand || $this->affichage_scan_requests) $this->result = str_replace('!!SUITE!!', $this->notice_childs.$this->affichage_resa_expl.$this->affichage_avis_detail.$this->affichage_demand.$this->affichage_scan_requests.$this->affichage_simili_search_head, $this->result);
