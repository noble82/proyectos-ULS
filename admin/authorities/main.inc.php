...
// +-------------------------------------------------+
// $Id: main.inc.php,v 1.5 2015-11-04 14:13:38 vtouchard Exp $
...
switch($sub) {
	...
	case 'templates':
		...
		break;
	case 'statuts' :
		$admin_layout = str_replace('!!menu_sous_rub!!', $msg['admin_menu_authorities_statuts'], $admin_layout);
		print $admin_layout;
		echo window_title($database_window_title.$msg['admin_menu_authorities_statuts'].$msg[1003].$msg[1001]);
