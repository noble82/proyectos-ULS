...
// +-------------------------------------------------+
// $Id: elements_records_list_ui.class.php,v 1.2 2016-01-04 10:39:02 apetithomme Exp $
...
class elements_records_list_ui extends elements_list_ui {
	...
	public function get_elements_list(){
		if (!$this->elements_list) {
			...
			$nb=0;
			$this->elements_list = $this->generate_records_list($this->contents);
		}
		return $this->elements_list;
	}
	
	private function generate_records_list($contents){
		global $dbh;
		$elements_list = '';
