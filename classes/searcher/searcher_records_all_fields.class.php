...
// +-------------------------------------------------+
// $Id: searcher_records_all_fields.class.php,v 1.1 2015-11-20 10:14:44 arenou Exp $
		...
		$queries = array();
 		...
 		if($this->user_query !== "*"){
 			if($this->aq_wew && count($this->aq->tree) !== count($this->aq_wew->tree)){
 				...
 				$query = $this->aq->get_query_mot("id_notice","notices_mots_global_index","word","notices_fields_global_index","value",$this->field_restrict,true,true);
 			}
 		}else{
