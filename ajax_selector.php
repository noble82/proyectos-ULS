...
// +-------------------------------------------------+
// $Id: ajax_selector.php,v 1.62 2016-01-07 11:06:12 dgoron Exp $
...
switch($completion):
	...
	case 'instruments':
		...
		if ($param1 && !$param2){ // que ceux du pupitre
			...
			$restrict1 = $restrict." AND instrument_musicstand_num ='$param1' ";
...
switch($completion){
	case 'instruments':
		if (SESSrights & ADMINISTRATION_AUTH) {
			...
			echo "<div id='l".$id."_add_instrument' style='cursor:default;font-family:arial, helvetica;font-size:10px;width:100%; background-color:#DDD' onClick='ajax_insert_element(\"$id\");'>".$msg['nomenclature_js_dialog_add_instrument']."</div>";
		}
		break;
}
