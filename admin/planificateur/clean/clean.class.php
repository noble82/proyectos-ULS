...
// +-------------------------------------------------+
// $Id: clean.class.php,v 1.10 2015-11-06 15:13:22 dgoron Exp $
	...
	function show_form ($param='') {
		...
		<div class='row'>
			...
			$form_task .= "
					...
					<div class='row'>
						<input type='checkbox' value='268435456' name='index_authorities' ".($index_authorities == "268435456" ? "checked" :"").">&nbsp;<label for='index_authorities'>".htmlentities($msg["nettoyage_index_authorities"], ENT_QUOTES, $charset)."</label>
					</div>
				</div>
			</div>";	
