...
// +-------------------------------------------------+
// $Id: show_cart.inc.php,v 1.59 2016-01-13 15:41:42 apetithomme Exp $
...
if (count($cart_)) {
	...
	if($precedente > 1) {
		print "<td width=\"14\" align=\"center\"><a href=\"index.php?lvl=show_cart&page=1\"><img src=\"".get_url_icon('first.gif')."\"";
		print " border=\"0\" alt=\"$msg[start]\"";
		print " title=\"$msg[first_page]\"></a></td>";
	} else {
		print "<td width=\"14\" align=\"center\"><img src=\"".get_url_icon('first-grey.gif')."\">";
	}

	if($precedente > 0) {
		print "<td width=\"14\" align=\"center\"><a href=\"index.php?lvl=show_cart&page=$precedente\"><img src=\"".get_url_icon('prev.gif')."\"";
		print " border=\"0\" alt=\"$msg[prec]\"";
		print " title=\"$msg[prec]\"></a></td>";
	} else {
		print "<td width=\"14\" align=\"center\"><img src=\"".get_url_icon('prev-grey.gif')."\">";
	}
	...
	if($suivante<=$nbepages) {
		print "<td width=\"14\" align=\"center\"><a href=\"index.php?lvl=show_cart&page=$suivante\"><img src=\"".get_url_icon('next.gif')."\"";
		print " border=\"0\" alt=\"$msg[next]\"";
		print " title=\"$msg[next]\"></a></td>";
	} else {
		print "<td width=\"14\" align=\"center\"><img src=\"".get_url_icon('next-grey.gif')."\">";
	}

	// affichage du lien vers la fin
	if($suivante < $nbepages) {
		print "<td width=\"14\" align=\"center\"><a href=\"index.php?lvl=show_cart&page=$nbepages\"><img src=\"".get_url_icon('last.gif')."\"";
		print " border=\"0\" alt=\"$msg[end]\"";
		print " title=\"$msg[end]\"></a></td>";
	} else {
		print "<td width=\"14\" align=\"center\"><img src=\"".get_url_icon('last-grey.gif')."\">";
	}
