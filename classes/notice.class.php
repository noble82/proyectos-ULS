...
// +-------------------------------------------------+
// $Id: notice.class.php,v 1.213 2016-01-05 17:26:53 apetithomme Exp $
		...
		static function delete_vedette_links($id) {	
			...
			if (pmb_mysql_num_rows($res_responsability)) {
				while($r=pmb_mysql_fetch_object($res_responsability)){
					...
					switch($type_aut){
						case 0:
							vedette_link::delete_vedette_link_from_object(new vedette_composee(0,'notice_authors'), $object_id, TYPE_NOTICE_RESPONSABILITY_PRINCIPAL);
							break;
						case 1:
							vedette_link::delete_vedette_link_from_object(new vedette_composee(0,'notice_authors'), $object_id,TYPE_NOTICE_RESPONSABILITY_AUTRE);
							break;
						case 2:
							vedette_link::delete_vedette_link_from_object(new vedette_composee(0,'notice_authors'), $object_id,TYPE_NOTICE_RESPONSABILITY_SECONDAIRE);
							break;
					}
				}
			}
