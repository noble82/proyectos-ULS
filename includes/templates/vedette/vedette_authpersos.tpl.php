...
// +-------------------------------------------------+
// $Id: vedette_authpersos.tpl.php,v 1.6 2015-12-10 11:14:44 ngantier Exp $
...
var vedette_authpersos = {
	...
	create_box : function(caller_property_name, parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel, vedette_composee_order) {
		...
		text.setAttribute("completion", "authperso_" + caller_property_authid );
		text.setAttribute("autocompletion", "on");
		text.setAttribute("autocomplete", "off");
		text.setAttribute("placeholder", "[" + caller_property_authlabel + "]");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "[" + caller_property_authlabel + "] " + document.getElementById(id).value;
	}
}
';