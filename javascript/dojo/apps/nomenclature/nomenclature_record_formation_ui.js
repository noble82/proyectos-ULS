...
// +-------------------------------------------------+
// $Id: nomenclature_record_formation_ui.js,v 1.21 2015-12-29 14:23:08 vtouchard Exp $
	  ...
	  return declare("nomenclature_record_formation_ui",[_WidgetBase], {
		  ...
		  hidden_record_formations:null,
			...
			init_formation: function(){
				...
				this.input_name.value = (this.record_formation.get_label() != "")?this.record_formation.get_label():registry.byId('nomenclature_datastore').get_message('nomenclature_js_partial_formation')+' '+(this.indice+1)+' ('+this.record_formation.formation.get_name()+')';
			...
			create_selector: function(){
				...
				this.own(on(this.type_selector, 'change', lang.hitch(this, this.update_record_formation)));	
			},
