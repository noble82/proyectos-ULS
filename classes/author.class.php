...
// +-------------------------------------------------+
// $Id: author.class.php,v 1.112 2015-12-21 15:41:49 vtouchard Exp $
...
if (! defined('AUTEUR_CLASS')) {
	...
	class auteur {
		...
		// ---------------------------------------------------------------
		                        ...
		                        // ---------------------------------------------------------------
		public function auteur($id = 0, $recursif = 0) {
			if ($id) {
		...
		public function update($value, $force = false) {
			...
			if ($this->id) {
				...
				if (pmb_mysql_query($requete, $dbh)) {
					...
					if ($opac_enrichment_bnf_sparql) {						auteur::author_enrichment($this->id);
					}
