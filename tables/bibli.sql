...
-- +-------------------------------------------------+
-- $Id: bibli.sql,v 1.74 2015-12-03 16:20:28 dgoron Exp $

-- MySQL dump 10.14  Distrib 5.5.28-MariaDB, for Linux (x86_64)
--
-- Host: localhost    Database: pmb430
-- ------------------------------------------------------
...
CREATE TABLE authorities (
  ...
  KEY i_object (num_object,type_object)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `grilles_auth`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE grilles_auth (
  grille_auth_type varchar(32) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  grille_auth_filter varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
-- Dump completed on 2015-12-01 14:43:32
