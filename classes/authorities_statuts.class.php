...
// +-------------------------------------------------+
// $Id: authorities_statuts.class.php,v 1.9 2015-12-08 09:38:23 dgoron Exp $
...
class authorities_statuts{
	...
	public static function get_form_for($auth_type, $auth_statut_id, $search=false){
        ...
        if($search){
        	...
        	if($auth_type == AUT_TABLE_CONCEPT){
        		$on_change='onchange="if(this.form) {check_submit(); this.form.submit();}"';
        	}
